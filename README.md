...
Both models clearly beat the baseline. `xG` dominates as the top feature in both the Linear Regression coefficients and Random Forest feature importance, three independent analyses (EDA correlation, LR coefficients, RF importances) all pointing to the same conclusion.
